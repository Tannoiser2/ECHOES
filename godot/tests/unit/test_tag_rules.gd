...
func test_with_no_signs_on_the_board_every_hook_is_neutral() -> void:
	...
	assert_eq(
		session.data.tag_rules.size(), 52,
		"le regole di D-105, i poteri di vita di D-109/D-124/D-126/D-129/D-130/D-131/D-133, i denti di D-117, le cicatrici di D-122, i gradi dell'insediamento di D-160, la foresta di D-163 e i due doni dei luoghi di D-165"
	)
