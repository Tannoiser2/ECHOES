...
| `python3 tools/validate_physical.py --check` | **la grammatica fisica**: segni muti, Domande che si aprirebbero sempre, carte senza Risonanza, Risonanze cieche, Temi senza mazzo |
