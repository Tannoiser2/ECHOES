...
`run_year_length_probe.gd` (quanti Consigli fa un anno sul banco delle prove —
la banda che `test_balance` sorveglia, misurata **chiamando** `test_case.gd`
invece di ricopiarlo).
