...
| **un gettone sul bordo della mappa** | 52 | 48 | **6** | quello che il mondo ricorda: sta dove sta il mondo, non su un luogo (D-351). |
...
| `burden_shared` | Conseguenza, carta Echo | — | carta Echo |
