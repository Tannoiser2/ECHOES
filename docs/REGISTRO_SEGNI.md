...
| `charter_written` | Conseguenza | — | Destino, chi siede l'anno prossimo, fatto che dura, pesca delle domande |
| `condition:abandoned` | Conseguenza | — | la Regione di cui si discute, pesca delle domande |
| `condition:contested` | Conseguenza, carta Asset | Conseguenza, carta Asset | la Regione di cui si discute |
| `condition:cut_off` | Conseguenza, carta Asset | Conseguenza, carta Asset | la Regione di cui si discute, pesca delle domande |
| `condition:emptied` | Conseguenza | — | Destino, la Regione di cui si discute, pesca delle domande |
...
| `condition:starving` | Conseguenza | Conseguenza, carta Asset | la Regione di cui si discute, pesca delle domande, regola del segno |
| `condition:unrest` | Conseguenza, carta Asset | Conseguenza, carta Asset | Destino, la Regione di cui si discute, pesca delle domande |
...
| `crystal_exploited` | Conseguenza | — | Destino, catena delle ere, chi **non** siede l'anno prossimo, chi siede l'anno prossimo, leggenda (un'era dopo), pesca delle domande |
| `debt_called` | Conseguenza, carta Asset | — | Destino, chi siede l'anno prossimo, leggenda (un'era dopo), pesca delle domande, regola del segno |
...
| `grain_requisitioned` | Conseguenza | — | chi siede l'anno prossimo, pesca delle domande |
| `heir_named` | Conseguenza, carta Asset | — | chi siede l'anno prossimo |
...
| `nahr_settled` | Conseguenza | — | Destino, chi siede l'anno prossimo, fatto che dura |
...
| `scar:emptied` | Conseguenza (cicatrice) | — | chi **non** siede l'anno prossimo, chi siede l'anno prossimo, conteggio delle cicatrici (`scar_count`), regola del segno |
| `scar:open_wound` | Conseguenza (cicatrice) | — | chi siede l'anno prossimo, conteggio delle cicatrici (`scar_count`), regola del segno |
...
| `structure:sealed` | Conseguenza | Conseguenza | Destino, chi **non** siede l'anno prossimo, la Regione di cui si discute |
| `study_supervised` | Conseguenza | — | Destino, pesca delle domande |
| `succession_by_law` | Conseguenza | — | Destino, chi siede l'anno prossimo, fatto che dura |
