...
| testi con una taglia | 207 |
| **piu' piccoli di 11 punti sul tablet** | **0** |
| sotto i 17 punti, che la guida chiama «corpo» | 205 |
...
| mappa | al centro | 15 | *si adatta* | |
| il Consiglio | a schermo intero | 87 | 974 | 182 |
| il tavolo | nella stanza, prima di sedersi | 40 | *si adatta* | |
