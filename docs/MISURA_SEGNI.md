...
| `burden_shared` | 49 | 0 | 0 | nessuno lo guarda |
| `charter_for_all` | 3 | 0 | 0 |  |
| `charter_written` | 7 | 0 | 2 |  |
| `condition:abandoned` | 52 | 0 | 0 | nessuno lo guarda |
| `condition:contested` | 522 | 2 | 2 |  |
| `condition:cut_off` | 110 | 1 | 1 |  |
| `condition:emptied` | 29 | 2 | 1 |  |
| `condition:exploited` | 8 | 1 | 1 |  |
| `condition:guarded` | 35 | 0 | 0 | nessuno lo guarda |
| `condition:indebted` | 11 | 0 | 0 | nessuno lo guarda |
| `condition:mourning` | 6 | 0 | 0 |  |
| `condition:plundered` | 27 | 0 | 0 | nessuno lo guarda |
| `condition:rationed` | 36 | 0 | 0 | nessuno lo guarda |
| `condition:unrest` | 202 | 5 | 0 |  |
| `crown_dispossessed` | 3 | 0 | 0 |  |
| `crown_divided` | 7 | 2 | 1 |  |
| `crystal_exploited` | 26 | 3 | 0 |  |
| `crystal_measured` | 4 | 0 | 0 |  |
| `debt_called` | 226 | 0 | 1 |  |
| `debt_forgiven` | 102 | 0 | 1 |  |
| `discovery:crystal` | 4 | 0 | 0 |  |
| `discovery:legend` | 156 | 0 | 0 | nessuno lo guarda |
| `discovery:relic` | 9 | 0 | 3 |  |
| `discovery:the_charter` | 5 | 0 | 0 |  |
| `discovery:the_ledger` | 335 | 0 | 0 | nessuno lo guarda |
| `discovery:the_omen` | 457 | 0 | 0 | nessuno lo guarda |
| `discovery:trade_ledger` | 197 | 0 | 0 | nessuno lo guarda |
| `discovery:written_law` | 163 | 0 | 0 | nessuno lo guarda |
| `distribution_audited` | 12 | 0 | 0 | nessuno lo guarda |
| `escort_sworn` | 214 | 0 | 2 |  |
| `failed_proposal` | 4 | 1 | 0 |  |
| `faith_established` | 6 | 0 | 0 |  |
| `grain_requisitioned` | 4 | 0 | 0 |  |
| `heir_named` | 72 | 0 | 0 | nessuno lo guarda |
| `knowledge_shared` | 144 | 0 | 0 | nessuno lo guarda |
| `ledger_public` | 152 | 1 | 1 |  |
...
| segno | scritto |
|---|---|
| `discovery:the_omen` | 457 |
| `discovery:the_ledger` | 335 |
| `discovery:trade_ledger` | 197 |
| `discovery:written_law` | 163 |
| `discovery:legend` | 156 |
| `knowledge_shared` | 144 |
| `heir_named` | 72 |
| `condition:abandoned` | 52 |
| `burden_shared` | 49 |
| `condition:rationed` | 36 |
| `condition:guarded` | 35 |
| `spoke_and_lost` | 29 |
| `someone_paid` | 28 |
| `condition:plundered` | 27 |
| `toll_shared` | 20 |
| `betrayal_spoken` | 15 |
| `scar:open_wound` | 13 |
| `took_by_hand` | 12 |
| `distribution_audited` | 12 |
| `account_settled` | 12 |
| `condition:indebted` | 11 |
