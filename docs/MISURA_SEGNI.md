...
| `charter_temporary` | 12 | 0 | 0 | `chronicle`, `entity` |  |
| `charter_written` | 50 | 0 | 2 | `asset_physical`, `destiny`, `entity`, `destiny_physical`, `chronicle`, `entity_strategic_profile` |  |
| `condition:abandoned` | 22 | 0 | 1 | `asset_physical`, `destiny_physical`, `tension`, `chronicle`, `echo_card`, `destiny` |  |
| `condition:contested` | 370 | 2 | 3 | `asset`, `asset_physical`, `consequence`, `destiny_physical`, `tension`, `destiny`, `echo_card` |  |
| `condition:cut_off` | 152 | 1 | 1 | `asset`, `asset_physical`, `chronicle`, `consequence`, `destiny`, `destiny_physical`, `echo_card`, `entity`, `entity_strategic_profile`, `tension` |  |
...
| `condition:guarded` | 100 | 0 | 0 | `entity_strategic_profile`, `tag_rule`, `echo_card` |  |
| `condition:indebted` | 304 | 0 | 0 | `consequence`, `destiny_physical`, `tension`, `chronicle` |  |
| `condition:lean` | 156 | 0 | 0 | `asset`, `asset_physical`, `consequence`, `tension` |  |
| `condition:mourning` | 43 | 0 | 0 | `asset`, `asset_physical`, `tension`, `chronicle` |  |
| `condition:plundered` | 45 | 0 | 0 | `asset_physical`, `consequence`, `tag_rule`, `tension`, `chronicle` |  |
...
| `descent_witnessed` | 21 | 0 | 0 | `chronicle` |  |
| `discovery:crystal` | 10 | 0 | 0 | `destiny`, `destiny_physical`, `entity_strategic_profile`, `objective` |  |
| `discovery:legend` | 162 | 0 | 0 | `destiny`, `entity_strategic_profile`, `objective` |  |
...
| `escort_sworn` | 196 | 0 | 2 | `asset_physical`, `destiny`, `destiny_physical`, `entity` |  |
...
| `rumour_running` | 19 | 1 | 1 | `destiny`, `destiny_physical`, `echo_card` |  |
| `scar:emptied` | 6 | 0 | 0 | `destiny_physical`, `entity`, `tag_rule` |  |
| `scar:open_wound` | 4 | 0 | 0 | `entity`, `tag_rule` |  |
| `someone_paid` | 3 | 0 | 0 | — |  |
| `spoke_and_lost` | 13 | 0 | 0 | — | nessuno lo guarda |
...
| `study_supervised` | 22 | 2 | 0 | `destiny`, `destiny_physical`, `chronicle`, `entity_strategic_profile` |  |
| `succession_by_law` | 33 | 0 | 1 | `destiny`, `entity`, `destiny_physical`, `entity_strategic_profile` |  |
...
| `water_moves` | 45 | 0 | 2 | `destiny`, `destiny_physical`, `entity_strategic_profile` |  |
