...
Stato 0.0.6: **92 test in 12 suite, 611 asserzioni, tutto verde**, più i 3 piani di
...
| `unit/test_echo_grammar.gd` | 4 | pescare una carta registra la funzione narrativa svolta, una carta che presuppone qualcosa non e giocabile finche quel qualcosa non e successo, ogni famiglia drammatica mantiene almeno una carta sempre giocabile, e il pool dell'Atto e un sacchetto pesato che da archi diversi su seed diversi tenendo l'Atto 1 in tensione |
