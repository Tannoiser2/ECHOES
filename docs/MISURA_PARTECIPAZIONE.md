...
|---|---|---|
| Consigli | 163 | 159 |
| prese di posizione dei non proponenti | 489 | 477 |
| — SUPPORT | 248 (51%) | 205 (43%) |
| — OPPOSE | 241 (49%) | 272 (57%) |
| — ABSTAIN | 0 (0%) | 0 (0%) |
| Consigli col tavolo in silenzio (tutti astenuti) | 0 (0%) | 0 (0%) |
| Consigli con un OPPOSE dichiarato | 145 (89%) | 150 (94%) |
| carte impegnate dal proponente, per Consiglio | 2.01 | 1.97 |
| carte impegnate dagli altri tre, per Consiglio | 5.54 | 5.11 |
| non proponenti che impegnano almeno una carta | 454 (93%) | 449 (94%) |
| gettoni di opposizione comprati (D-419) | 0 | 0 |
| punti del dibattito guadagnati · persi (D-455) | 0 · 0 | 0 · 0 |
| margine medio | 2.57 | 1.84 |
| **Consigli con opposizione nel margine** | **145 (89%)** | **150 (94%)** |
...
|---|---|---|---|---|
| Re Aldric | misto | 34 | 27 | 0 |
| Re Aldric | uniforme | 24 | 29 | 0 |
| Kessa dei Fuochi | misto | 46 | 38 | 0 |
| Kessa dei Fuochi | uniforme | 35 | 58 | 0 |
...
| Maestra Ilve | misto | 35 | 22 | 0 |
| Maestra Ilve | uniforme | 22 | 29 | 0 |
| Vaerax | misto | 30 | 28 | 0 |
| Vaerax | uniforme | 20 | 32 | 0 |
| Priore Anselmo | misto | 23 | 29 | 0 |
| Priore Anselmo | uniforme | 20 | 30 | 0 |
...
| gettoni medi sul mucchio | 6.28 | 6.44 |
| carte della parte piu' forte (media) | 13.20 | 11.94 |
| **Consigli in cui la parte piu' forte arriva al mucchio** | **163 (100%)** | **159 (100%)** |
