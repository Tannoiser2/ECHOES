# ECHOES — I testi, per la revisione

<!-- GENERATO da `python3 tools/build_review.py` — non si corregge qui: -->
<!-- si segnala la correzione, si riporta nei dati, si rigenera. -->

Ogni testo che un giocatore può leggere, nell'ordine in cui lo incontra,
...
> Nessuno scenario, nessun nome scritto prima: le tessere della mappa si pescano dalla scatola, le case si pescano dal mucchio, e i sei mazzetti dei Temi si mischiano coperti. Le domande dell'anno sono quelle che questa mappa sa reggere. Quello che succede qui e' il Punto Zero della saga: la seconda era giochera' sulle stesse tessere, e ricordera'.
...
> Il raccordo. Non produce nulla e tocca tutto: chi la tiene sa prima degli altri.


**`REG_TERRE_NAHR`**
> Terre Nahr

> Pascoli larghi e magri. I Nahr li percorrono da sempre; quest'anno li stanno lasciando.


**`REG_VALLE_VERDE`**
> Valle Verde

> Il ventre del regno. Quest'anno la terra restituisce meno di quanto riceve.


## 3. Le Casate — chi siede al tavolo
...
> Nelle Miniere Antiche le lampade si spengono tutte insieme, e si riaccendono da sole.
...
> Nei villaggi si smette di stringere la mano e nessuno lo ha deciso.


**`TEN_PLAGUE, presagio al 4`**
...
> A Eredan il sigillo del trono viene cambiato due volte nello stesso mese.


**`TEN_SUCCESSION, presagio al 5`**
...
**`Q_ASH_WATCH`**
> La montagna fuma di nuovo $in_region: si mette qualcuno a guardarla, o si scrive che ha sempre fumato?
...
**`Q_ECHOES_WHO`**
> In fondo qualcosa risponde ai colpi $in_region: si scende a vedere chi, o si smette di battere?
...
**`Q_ENCLOSURE_POSTS`**
> I pali sono spuntati di notte $in_region: si tolgono, o si scrive chi li ha piantati?
...
**`Q_FLOOD_DIKES`**
> La palude è salita di un palmo $in_region: si rifanno gli argini, o si arretra?
...
**`Q_HERESY_PREACH`**
> Si predica una parola nuova $in_region: si stabilisce cosa si può dire, o si lascia dire?
...
**`Q_SHRINE_KEEP`**
> Sull'isola c'è un altare più vecchio della fede che lo usa: chi lo custodisce?
...
**`Q_LANDLESS_PACT`**
> Braccia senza terra e terra senza braccia: si scrive un patto di lavoro, o si lascia contrattare?
...
**`Q_LEVY_ARMS`**
> $in_region, chi decide quante braccia vanno alle armi?
...
**`Q_MARSH_FEVER_WATER`**
> $in_region, chi manda gli uomini a prosciugare?
...
**`Q_CHANNELS_MAP`**
> Le vie di prima portano tutte nello stesso posto: si mappano, o le trova chi capita?
...
**`Q_NAMES_MEAN`**
> I nomi vecchi sono tornati sui muri: si stabilisce cosa vogliono dire, o si cancellano?
...
**`Q_PILGRIMS_FEED`**
> I pellegrini continuano ad arrivare $in_region: si dà loro da mangiare, o si chiude la strada?
...
**`Q_REFUGEES_ROOM`**
> $in_region, chi decide dove si fermano quelli che arrivano?
...
**`Q_SANCTUARY_LIMITS`**
> Un ricercato tiene l'altare $in_region: dove finisce l'asilo?
...
**`Q_BELLS_RING`**
> Le campane tacciono da tre lune $in_region: si torna a suonarle, e per chi?
...
**`Q_SLEEPERS_COUNT`**
> I racconti contano sette dormienti e uno si è svegliato: si contano sul serio, o si smette di contarli?
...
**`Q_TITHE_LEDGER`**
> Metà della decima si perde fra il campo e l'altare: si aprono i registri, o si lascia stare?
...
**`Q_WINTER_WOOD`**
> $in_region, chi distribuisce la legna quando gela?
...
> Non si risolve: si va via. Quello che resta indietro smette di essere di qualcuno.


**`CNS_ABANDONED, cicatrice`**
> Le case in piedi e le porte aperte, e dentro niente che valga la pena portare via.
...
**`CNS_ASH_WATCH`**
> La Veglia sulla Montagna

> Due torri e un turno di guardia che nessuno salta. Non impedisce niente: fa sapere prima — e da quel momento sulla montagna c'e' qualcosa che ha un nome sopra.


**`CNS_CANALS_DUG`**
> I Canali Riaperti

> Si scava per due stagioni, e il fiume ricomincia ad arrivare dove arrivava prima. La parte difficile non era scavare: era decidere chi mandava gli uomini.
...
> Sulla porta nord il nome vecchio si legge ancora sotto quello nuovo.
...
> Passa, ma chi ha ceduto se lo ricorda. Non e' una rottura dichiarata: e' un rapporto che da adesso si tiene a distanza di braccio.
...
> Passa, e la gente vota coi piedi. Il posto accanto si assottiglia di una famiglia alla volta, senza che nessuno lo dichiari.


**`CNS_COST_EXPLOITED`**
> Si Spreme Quello Che C'e'

> Passa, e il posto rende oltre quello che puo'. Rende adesso; l'anno prossimo si vedra'.


**`CNS_COST_GUARD`**
> Gli Uomini alla Porta

> Passa, e va sorvegliata. Da adesso c'e' sempre qualcuno di guardia, e la guardia si paga tutti i giorni.


**`CNS_COST_MOURNING`**
> Il Conto in Vite

> Passa, e qualcuno non c'e' piu' per farlo passare. Si contano i morti dopo, e si mette il lutto sulla porta.


**`CNS_COST_RATION`**
> La Cinghia Stretta

> Passa, e si passa a razione. Quello che c'e' basta perche' qualcuno riceva meno, e quel qualcuno lo sa.


**`CNS_COST_UNREST`**
> Il Prezzo del Consenso

> La proposta passa, ma qualcuno la paga senza averla votata. Le strade di Eredan si riempiono di gente che aspetta.
...
> Il Cristallo Rosso esce dalle gallerie a peso. Quello che era una domanda diventa una voce di bilancio.
...
> Non un esercito: dodici persone che rispondono di ogni carico con il proprio nome.


**`CNS_EXODUS`**
> La Partenza

> Non se ne vanno tutti, e non se ne va nessuno del tutto. Ma qualcosa parte e non torna quell'anno.


**`CNS_FAILURE_ABANDONED`**
> Lo Lasciano Andare

> Non si decide, e allora nessuno se ne occupa. Il posto resta li', e smette di essere di qualcuno.


**`CNS_FAILURE_CONTESTED`**
> Resta Conteso

> Non si decide, e allora decide chi c'e'. Il posto resta di due padroni, che e' come dire di nessuno.


**`CNS_FAILURE_CUT_OFF`**
> Si Chiude la Strada

> Non si decide, e chi puo' chiude. Il posto accanto resta fuori dai conti finche' qualcuno non torna a parlare.


**`CNS_FAILURE_PLUNDER`**
> Qualcuno Si Serve

> Non si decide, e allora si prende. Non e' una razzia dichiarata: e' un magazzino che al mattino ha meno dentro.


**`CNS_FAILURE_RUMOUR`**
> La Voce Corre

> Non si decide, e quello che non si e' deciso si racconta. Fuori dalla sala la versione e' gia' un'altra.
...
> La domanda a cui il consiglio non ha risposto, rimasta scritta su un muro.


**`CNS_FAILURE_WALL`**
> La Domanda sul Muro

> Non si decide, e resta scritto. Qualcuno ha inciso la domanda dove tutti la leggono, e nessuno la cancella.


**`CNS_FAILURE_WALL, cicatrice`**
> La domanda che il Consiglio non ha saputo chiudere, incisa dove passa la gente.


**`CNS_HARVEST_RETURNS`**
> Il Raccolto Torna

> Una stagione onesta. Non ripaga niente, ma toglie la fame dal tavolo per un anno.


**`CNS_HEIR_NAMED`**
> L'Erede Nominato

> Un nome detto ad alta voce davanti a chi conta. Da quel momento contestarlo costa qualcosa.
...
> Il mercato non chiude: si sposta. E dove arriva, cambia chi comanda davvero.
...
> Le due teste del ponte, ancora in piedi, con niente in mezzo.
...
> Aprire le gallerie significa metterci qualcuno a contare quello che esce. Il controllo lo decide il Consiglio; quello che resta e' che da adesso, li' sotto, qualcuno conta.
...
> La Valle si apre a chi arriva da est. Il confine non viene abolito: viene spostato dentro le persone.


**`CNS_OATH_BROKEN`**
> Il Patto Rotto

> Qualcuno fa esattamente la cosa che aveva promesso di non fare, e lo fa dove si vede.
...
> Non un privilegio: un incarico, con una firma sotto. Da quel giorno chi custodisce lo fa per conto di tutti, e deve rendere conto a tutti.


**`CNS_ORDER_RESTORED`**
> L'Ordine Rimesso in Piedi

> Le guardie tornano a girare in due invece che in sei, e la gente smette di contarle.
...
> Chi non ha scorta smette di partire. Chi parte non torna con quello che aveva.
...
**`CNS_ROYAL_GRANARY`**
> Il Granaio del Trono

> Il grano della Valle passa dalle mani del trono prima di arrivare a una tavola. Chi lo distribuisce decide chi mangia.


**`CNS_SEALED_VALLEY`**
> La Valle Chiusa

> I confini si chiudono. La Valle nutre Eredan e nessun altro, e le Terre Nahr imparano cosa significa un inverno senza uscita.
...
> Scalda Potere **oppure** Vie +1, scegli tu. Contare e' un atto di governo, e chi viene contato lo sa. Se il luogo porta #pascolo: Potere +2, e ci resta #malcontento.
...
> Scalda Fede **oppure** Potere +2, scegli tu. Un interdetto non toglie niente a nessuno: dice solo che d'ora in poi c'e' un dentro e un fuori. Se la fede ha avuto un posto: Fede +3.
...
> Scalda Fede **oppure** Potere +1, scegli tu. Un titolo dato e' una gerarchia detta ad alta voce, e qualcuno la sentira' come un insulto. Se porti #fama: Fede +2.
...
> Scalda Potere **oppure** Vie +1, scegli tu. Un magistrato e' la corona che arriva dove la corona non va di persona. Se la Carta e' stata scritta: Potere +2.
...
> ACQUISIRE su Legami. Fonti: Montagne Rosse, Miniere Antiche, Porto Cinerino, L'Isola Muta, Il Molo Nuovo, La Bocca della Miniera.
...
> Scalda Fede **oppure** Potere +2, scegli tu. Una promessa di nozze e' un patto che coinvolge chi non era nella stanza. Se porti #fama: Fede +3.
...
> Scalda Antico **oppure** Fede +1, scegli tu. Il sangue non e' un argomento: e' un modo di non doverne portare nessuno. Se l'erede e' stato nominato: Antico +2.
...
> Scalda Fede **oppure** Potere +2, scegli tu. Un patto rotto non si dimentica: cambia quello che gli altri sono disposti a promettere a chiunque. Se il giuramento e' stato rotto: Fede +3.
...
> Scalda Terra **oppure** Fede +1, scegli tu. Il diritto d'ospitalita' regge finche' nessuno lo mette alla prova, e qualcuno lo mettera'. Se porti la scorta giurata: Terra +2.
...
> Scalda Fede **oppure** Potere +2, scegli tu. Un ostaggio tiene fermo il tavolo e intanto insegna a tutti come si tiene fermo un tavolo. Se il tradimento e' stato detto ad alta voce: Fede +3.
...
> Scalda Fede **oppure** Potere +1, scegli tu. Un giuramento pronunciato e' una cosa che il mondo dovra' ricordare o dimenticare, e nessuna delle due e' gratis. Se porti #fama: Fede +2.
...
> Scalda Fede **oppure** Vie +1, scegli tu. Un debito vecchio non e' una somma: e' una storia che qualcuno raccontera' diversamente. Se il debito e' stato chiamato: Fede +2.
...
> ACQUISIRE su Forza. Fonti: Eredan, Montagne Rosse, Il Bosco dei Confini, Eredan delle Sei Porte, La Radura Tagliata.
...
> Scalda Terra **oppure** Potere +1, scegli tu. Un confine sorvegliato e' un confine che qualcuno ha appena disegnato. Se il luogo porta #pascolo: Terra +2, e ci resta #malcontento.
...
> Scalda Potere **oppure** Terra +2, scegli tu. Le porte bruciate si raccontano per due generazioni, e nessuna versione e' la tua. Se una domanda e' rimasta aperta: Potere +3.
...
> Scalda Sopravvivenza **oppure** Potere +1, scegli tu. I campi restano soli: chi tiene la lancia non tiene la falce. Se il luogo e' #magro: Sopravvivenza +2, e ci resta #fame.
...
> Scalda Vie **oppure** Potere +1, scegli tu. Chi si compra si ricompra, e il prezzo lo sa gia' qualcun altro. Se il debito e' stato chiamato: Vie +2.
...
> Scalda Vie **oppure** Potere +1, scegli tu. Una strada su cui c'e' un posto di blocco non e' piu' una strada: e' una porta, e le porte si contano. Se il pedaggio si divide: Vie +2.
...
> Scalda Terra **oppure** Potere +2, scegli tu. Un assedio si vede da lontano, e chi ha fame lo racconta prima di chi comanda. Se il grano e' stato requisito: Terra +3.
...
> Scalda Terra **oppure** Potere +2, scegli tu. Una banda armata non torna indietro uguale, e nemmeno il posto da cui e' passata. Se il luogo e' #saccheggiato: Terra +3, e ci resta #malcontento.
...
> Scalda Antico **oppure** Vie +1, scegli tu. Un archivio non conserva il passato: conserva la versione che qualcuno ha avuto il tempo di scrivere. Se i conti sono pubblici: Antico +2.
...
> Scalda Antico **oppure** Vie +1, scegli tu. Una strada che qualcuno ha ritrovato e' una strada che qualcun altro vorra' chiudere. Se il luogo porta #commercio: Antico +2.
...
> Scalda Fede **oppure** Potere +1, scegli tu. Una prova non chiude una discussione: decide chi dovra' chiamare bugiardo chi. Se quello che si e' saputo lo sanno tutti: Fede +2.
...
> Scalda Antico **oppure** Fede +1, scegli tu. Il Risveglio non distingue fra chi scava e chi guarda. Se il Cristallo e' stato sfruttato: Antico +3, e ci resta #sfruttato.
...
> Scalda Antico **oppure** Fede +1, scegli tu. Una voce di corridoio e' una verita' che non ha ancora deciso di chi essere. Se il tradimento e' stato detto ad alta voce: Antico +2.
...
> Scalda Potere **oppure** Fede +2, scegli tu. Una deposizione sigillata pesa uguale aperta o chiusa: quello che conta e' che esista. Se una domanda e' rimasta aperta: Potere +3.
...
> Scalda Fede **oppure** Potere +2, scegli tu. Un testimone non porta la verita': porta la propria, e adesso il tavolo deve scegliere. Se il tradimento e' stato detto ad alta voce: Fede +3.
...
> Scalda Sopravvivenza **oppure** Potere +1, scegli tu. Una folla che si raduna mangia dove si raduna, e i conti li fa il posto. Se il grano e' stato requisito: Sopravvivenza +2.
...
> Scalda Antico **oppure** Fede +1, scegli tu. Chi ricorda decide cosa c'era prima, e cosa c'era prima decide cosa e' giusto adesso. Se la fede ha avuto un posto: Antico +2.
...
> Scalda Terra **oppure** Sopravvivenza +2, scegli tu. Un esodo non si annulla: il posto da cui si e' partiti resta com'e' rimasto. Se i Nahr si sono fermati: Terra +3, e ci resta la Cicatrice «lo sgombero».
...
> Scalda Sopravvivenza **oppure** Terra +1, scegli tu. Una marcia non torna indietro da sola: qualcuno deve prometterle qualcosa. Se sul luogo c'e' #fame: Sopravvivenza +2, e ci resta #malcontento.
...
> Scalda Sopravvivenza **oppure** Terra +2, scegli tu. Chi si mobilita non lavora, e chi non lavora mangia lo stesso. Se una domanda e' rimasta aperta: Sopravvivenza +3.
...
> Scalda Potere **oppure** Fede +1, scegli tu. Un portavoce e' qualcuno che ha deciso di chi e' la voce, e l'ha deciso prima di parlare. Se la richiesta e' stata ascoltata: Potere +2.
...
> Scalda Vie **oppure** Sopravvivenza +2, scegli tu. Quando le braccia si fermano, le prime cose che non arrivano sono quelle che venivano da lontano. Se il pedaggio si divide: Vie +3.
...
> Scalda Vie **oppure** Potere +1, scegli tu. Il credito e' una corda: la tiene chi presta, e la sente chi la porta al collo. Se il debito e' stato chiamato: Vie +2.
...
> Scalda Sopravvivenza **oppure** Potere +2, scegli tu. Le chiavi non fanno il grano: decidono soltanto chi resta fuori dalla porta. Se il grano e' stato requisito: Sopravvivenza +3.
...
> Scalda Terra **oppure** Vie +2, scegli tu. Un'ipoteca sulla terra e' una domanda su chi ci vive, fatta a chi non e' presente. Se il debito e' stato chiamato: Terra +3.
...
> Scalda Vie **oppure** Sopravvivenza +1, scegli tu. Il sale e' l'unica merce che tutti comprano e nessuno vuole nominare. Se il pedaggio si divide: Vie +2.
...
> Scalda Vie **oppure** Potere +1, scegli tu. Ogni pedaggio e' un prezzo che qualcuno non aveva messo in conto. Se il debito e' stato chiamato: Vie +2.
...
> Tenere Eredan indipendente e raggiungere un controllo politico sufficiente, senza lasciare il regno in collasso.


**`DST_ALDRIC, minimum`**
> Il trono regge

> Una pedina dove c'e' il #capitale, o su una terra di #territorio


**`DST_ALDRIC, victory`**
> Il regno decide

> La corona tiene ancora la sua terra · La Carestia non supera 4
...
**`DST_CENERE, minimum`**
> Restano sulla montagna

> La terra col #selvaggio e' presidiata, non solo abitata


**`DST_CENERE, victory`**
> Chi scava lo dicono loro

> La montagna è ancora loro · E la veglia sulla montagna è affidata a loro, per atto e non per abitudine · E la terra della #miniera non e' stata murata
...
> Non hanno lasciato la montagna

> E qualcuno di loro e' rimasto sulla terra col #selvaggio


**`DST_CENERE_DEEP, victory`**
> E hanno visto cosa c'è sotto

> La terra della #miniera non e' stata murata · E sono scesi in due nella #miniera, non hanno solo guardato · E quello che c'è sotto l'hanno visto coi propri occhi
...
> Le citta' hanno alzato almeno un'opera


**`DST_LIBERE_WATER, victory`**
> E l'acqua si muove

> I canali sono stati riaperti · Una pedina dove c'e' il #granaio, o su una terra di #sopravvivenza · E il mondo non è stato aperto in più di due punti: l'acqua non torna dove si è combattuto
...
> Qualcosa è stato insegnato

> Qualcuno ha imparato qualcosa
...
**`DST_NAHR`**
> Una Terra dove Fermarsi

> Ottenere una patria stabile conservando autonomia e cultura del popolo.


**`DST_NAHR, minimum`**
> Il popolo sopravvive

> Una pedina dove c'e' il #pascolo, o su una terra di #sopravvivenza
...
> Una pedina dove c'e' il #commercio, o su una terra di #risorse


**`DST_SALE, victory`**
> Il debito è stato chiamato, e nessuno lo ha cancellato

> Il debito è stato chiamato per intero · E chi lo doveva non le è diventato nemico
...
> Il registro è stato aperto · Almeno una Regione controllata · E i conti che il registro tiene sono chiusi tutti
...
> Vincere non è prendere: è una firma che vale, e finire la cronaca senza debiti a verbale. Nessuna proposta caduta, nessuna domanda lasciata aperta, nessun giuramento spezzato nel mondo che lasci.


**`DST_SHARED_ACCOUNTS, minimum`**
> Due conti tenuti sotto controllo

> Due questioni tenute sotto il punto di rottura


**`DST_SHARED_ACCOUNTS, victory`**
> Nessuna domanda lasciata aperta

> Nessuna questione lasciata aperta
...
> Quando l'anno si chiude, chi ha le mani piene detta le condizioni del prossimo. Le riserve non fanno rumore: pesano.


**`DST_SHARED_HAND, minimum`**
> Le mani non vuote

> Tre carte in mano a fine anno
...
> Quando gli altri chiedono, tu hai
...
> Chiunque tu sia, la domanda è la stessa: quanta terra risponde quando chiami? Un'ambizione semplice e spietata - contare le Regioni, e contarle tue.


**`DST_SHARED_LAND, minimum`**
> Un posto che risponde

> Almeno una Regione controllata
...
> Chiunque tu sia, quello che sai nessuno te lo toglie. Scendere, guardare, mettere a verbale: il sapere è l'unica terra che non si può occupare.


**`DST_SHARED_LORE, minimum`**
> Una cosa vista

> Almeno una scoperta all'attivo
...
> Il mondo peggiora da solo: le questioni salgono per conto loro. Tenerle giù per un anno intero non è una cosa che capita — è una cosa che si fa.


**`DST_SHARED_QUIET, minimum`**
> Tre questioni tenute giù

> Tre questioni sotto il punto di rottura
...
> Non importa da dove vieni: importa che quando parli, il tavolo ascolta. La stessa ambizione per chiunque la giuri - la fama, e un posto da cui difenderla.


**`DST_SHARED_RENOWN, minimum`**
> Un posto che risponde al tuo nome

> Almeno una terra risponde al tuo nome


**`DST_SHARED_RENOWN, victory`**
> Il nome è conosciuto
...
**`DST_VAERAX`**
> Cio che Dorme Resti Addormentato

> Impedire lo sfruttamento incontrollato del Cristallo e preservare le Montagne Rosse.


**`DST_VAERAX, minimum`**
> La montagna è ancora sua

> Una pedina sulla terra col #selvaggio, o su una d'#antico
...
> Il mondo dimentica ancora la montagna
...
**`DST_VETRO, minimum`**
> L'Ordine tiene la sua casa

> La terra della #miniera e' presidiata, non solo abitata
