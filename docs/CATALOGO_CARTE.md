...
**RISONANZA (avviene sempre)** — Scalda Fede **oppure** Vie +1, scegli tu. Un favore non si restituisce mai per intero: e' questo che lo tiene in vita. Se ci si e' parlato: Fede +2.
