...
**RISONANZA (avviene sempre)** — Scalda Fede **oppure** Potere +2, scegli tu. Un interdetto non toglie niente a nessuno: dice solo che d'ora in poi c'e' un dentro e un fuori. Se la fede ha avuto un posto: Fede +3.
...
**RISONANZA (avviene sempre)** — Scalda Potere **oppure** Vie +1, scegli tu. Un magistrato e' la corona che arriva dove la corona non va di persona. Se la Carta e' stata scritta: Potere +2.
...
**RISONANZA (avviene sempre)** — Scalda Fede **oppure** Potere +1, scegli tu. Un titolo dato e' una gerarchia detta ad alta voce, e qualcuno la sentira' come un insulto. Se porti #fama: Fede +2.
...
**RISONANZA (avviene sempre)** — Scalda Fede **oppure** Potere +2, scegli tu. Un patto rotto non si dimentica: cambia quello che gli altri sono disposti a promettere a chiunque. Se il giuramento e' stato rotto: Fede +3.
...
**RISONANZA (avviene sempre)** — Scalda Fede **oppure** Potere +2, scegli tu. Un ostaggio tiene fermo il tavolo e intanto insegna a tutti come si tiene fermo un tavolo. Se il tradimento e' stato detto ad alta voce: Fede +3.
...
**RISONANZA (avviene sempre)** — Scalda Fede **oppure** Potere +2, scegli tu. Una promessa di nozze e' un patto che coinvolge chi non era nella stanza. Se porti #fama: Fede +3.
...
**RISONANZA (avviene sempre)** — Scalda Legami **oppure** Potere +1, scegli tu. Un favore chiesto al momento giusto vale piu' di un argomento, e chi lo concede lo ricorda.
...
**RISONANZA (avviene sempre)** — Scalda Terra **oppure** Fede +1, scegli tu. Il diritto d'ospitalita' regge finche' nessuno lo mette alla prova, e qualcuno lo mettera'. Se porti la scorta giurata: Terra +2.
...
**RISONANZA (avviene sempre)** — Scalda Fede **oppure** Potere +1, scegli tu. Un giuramento pronunciato e' una cosa che il mondo dovra' ricordare o dimenticare, e nessuna delle due e' gratis. Se porti #fama: Fede +2.
...
**RISONANZA (avviene sempre)** — Scalda Fede **oppure** Vie +1, scegli tu. Un debito vecchio non e' una somma: e' una storia che qualcuno raccontera' diversamente. Se il debito e' stato chiamato: Fede +2.
...
**RISONANZA (avviene sempre)** — Scalda Potere **oppure** Terra +2, scegli tu. Le porte bruciate si raccontano per due generazioni, e nessuna versione e' la tua. Se una domanda e' rimasta aperta: Potere +3.
...
**RISONANZA (avviene sempre)** — Scalda Terra **oppure** Potere +2, scegli tu. Un assedio si vede da lontano, e chi ha fame lo racconta prima di chi comanda. Se il grano e' stato requisito: Terra +3.
...
**RISONANZA (avviene sempre)** — Scalda Terra **oppure** Potere +2, scegli tu. Una banda armata non torna indietro uguale, e nemmeno il posto da cui e' passata. Se il luogo e' #saccheggiato: Terra +3, e ci resta #malcontento.
...
**RISONANZA (avviene sempre)** — Scalda Sopravvivenza **oppure** Potere +1, scegli tu. I campi restano soli: chi tiene la lancia non tiene la falce. Se il luogo e' #magro: Sopravvivenza +2, e ci resta #fame.
...
**RISONANZA (avviene sempre)** — Scalda Vie **oppure** Potere +1, scegli tu. Chi si compra si ricompra, e il prezzo lo sa gia' qualcun altro. Se il debito e' stato chiamato: Vie +2.
...
**RISONANZA (avviene sempre)** — Scalda Vie **oppure** Potere +1, scegli tu. Una strada su cui c'e' un posto di blocco non e' piu' una strada: e' una porta, e le porte si contano. Se il pedaggio si divide: Vie +2.
...
**RISONANZA (avviene sempre)** — Scalda Antico **oppure** Fede +1, scegli tu. Il Risveglio non distingue fra chi scava e chi guarda. Se il Cristallo e' stato sfruttato: Antico +3, e ci resta #sfruttato.
...
**RISONANZA (avviene sempre)** — Scalda Potere **oppure** Fede +2, scegli tu. Una deposizione sigillata pesa uguale aperta o chiusa: quello che conta e' che esista. Se una domanda e' rimasta aperta: Potere +3.
...
**RISONANZA (avviene sempre)** — Scalda Fede **oppure** Potere +2, scegli tu. Un testimone non porta la verita': porta la propria, e adesso il tavolo deve scegliere. Se il tradimento e' stato detto ad alta voce: Fede +3.
...
**RISONANZA (avviene sempre)** — Scalda Antico **oppure** Vie +1, scegli tu. Una strada che qualcuno ha ritrovato e' una strada che qualcun altro vorra' chiudere. Se il luogo porta #commercio: Antico +2.
...
**RISONANZA (avviene sempre)** — Scalda Terra **oppure** Sopravvivenza +2, scegli tu. Un esodo non si annulla: il posto da cui si e' partiti resta com'e' rimasto. Se i Nahr si sono fermati: Terra +3, e ci resta la Cicatrice «lo sgombero».
...
**RISONANZA (avviene sempre)** — Scalda Vie **oppure** Sopravvivenza +2, scegli tu. Quando le braccia si fermano, le prime cose che non arrivano sono quelle che venivano da lontano. Se il pedaggio si divide: Vie +3.
...
**RISONANZA (avviene sempre)** — Scalda Sopravvivenza **oppure** Terra +2, scegli tu. Chi si mobilita non lavora, e chi non lavora mangia lo stesso. Se una domanda e' rimasta aperta: Sopravvivenza +3.
...
**RISONANZA (avviene sempre)** — Scalda Potere **oppure** Fede +1, scegli tu. Un portavoce e' qualcuno che ha deciso di chi e' la voce, e l'ha deciso prima di parlare. Se la richiesta e' stata ascoltata: Potere +2.
...
**RISONANZA (avviene sempre)** — Scalda Sopravvivenza **oppure** Potere +1, scegli tu. Una folla che si raduna mangia dove si raduna, e i conti li fa il posto. Se il grano e' stato requisito: Sopravvivenza +2.
...
**RISONANZA (avviene sempre)** — Scalda Sopravvivenza **oppure** Terra +1, scegli tu. Una marcia non torna indietro da sola: qualcuno deve prometterle qualcosa. Se sul luogo c'e' #fame: Sopravvivenza +2, e ci resta #malcontento.
...
**RISONANZA (avviene sempre)** — Scalda Terra **oppure** Vie +2, scegli tu. Un'ipoteca sulla terra e' una domanda su chi ci vive, fatta a chi non e' presente. Se il debito e' stato chiamato: Terra +3.
...
**RISONANZA (avviene sempre)** — Scalda Potere **oppure** Vie +2, scegli tu. Un tesoro aperto e' una promessa; un tesoro chiuso e' un'accusa. Nessuno dei due resta segreto. Se la corona e' stata spogliata: Potere +3.
...
**RISONANZA (avviene sempre)** — Scalda Sopravvivenza **oppure** Potere +2, scegli tu. Le chiavi non fanno il grano: decidono soltanto chi resta fuori dalla porta. Se il grano e' stato requisito: Sopravvivenza +3.
...
**RISONANZA (avviene sempre)** — Scalda Vie **oppure** Potere +1, scegli tu. Il credito e' una corda: la tiene chi presta, e la sente chi la porta al collo. Se il debito e' stato chiamato: Vie +2.
...
**RISONANZA (avviene sempre)** — Scalda Vie **oppure** Potere +1, scegli tu. Ogni pedaggio e' un prezzo che qualcuno non aveva messo in conto. Se il debito e' stato chiamato: Vie +2.
...
*48 carte e 63 pezzi diversi da fare.*
