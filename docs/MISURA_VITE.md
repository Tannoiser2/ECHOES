...
| 12 | 8 | La Lega delle Sette | ENT_LIBERE | ON_TAG | `charter_written` | 372 |
| 8 | 8 | La Repubblica della Valle | ENT_ALDRIC | LINE_EXHAUSTED | — | 340 |
| 6 | 8 | L'Egemonia di Eredan | ENT_LIBERE | ON_TAG | `scar:emptied@REG_VALLE_VERDE` | 475 |
| 7 | 7 | Il Banco Nero | ENT_SALE | ON_TAG | `debt_called` | 535 |
| 5 | 6 | L'Accademia delle Misure | ENT_LYRA | ON_TAG | `succession_by_law` | 457 |
| 4 | 6 | Le Strade della Cenere | ENT_CENERE | ON_TAG | `condition:cut_off` | 437 |
| 7 | 3 | Il Regno di Nahr | ENT_NAHR | ON_TAG | `nahr_settled` | 595 |
...
| 3 | 3 | La Scuola del Vetro | ENT_VETRO | ON_TAG | `escort_sworn` | 494 |
