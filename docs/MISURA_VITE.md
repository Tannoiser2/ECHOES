...
| 12 | 9 | La Diaspora di Nahr | ENT_NAHR | ON_TAG | `twice_uprooted` | 406 |
| 10 | 8 | La Repubblica della Valle | ENT_ALDRIC | LINE_EXHAUSTED | — | 465 |
| 5 | 13 | L'Egemonia di Eredan | ENT_LIBERE | ON_TAG | `scar:emptied@REG_VALLE_VERDE` | 672 |
| 7 | 9 | La Lega delle Sette | ENT_LIBERE | ON_TAG | `charter_written` | 411 |
| 8 | 7 | Il Banco Nero | ENT_SALE | ON_TAG | `debt_called` | 374 |
| 6 | 7 | I Forni Riaccesi | ENT_CENERE | ON_TAG | `scar:open_wound` | 260 |
| 8 | 5 | Vaerax Ridestato | ENT_VAERAX | ON_TAG | `crystal_exploited` | 444 |
| 7 | 5 | Il Regno di Nahr | ENT_NAHR | ON_TAG | `nahr_settled` | 707 |
