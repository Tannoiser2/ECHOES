...
|---|---|---|---|---|---|---|
| 14 | 15 | Le Custodi della Cenere | ENT_CENERE | LINE_EXHAUSTED | — | 290 |
| 14 | 13 | I Frati del Vetro | ENT_VETRO | LINE_EXHAUSTED | — | 452 |
| 15 | 11 | Gli Ospiti di Nahr | ENT_NAHR | ON_TAG | `burden_shared` | 343 |
| 12 | 10 | L'Egemonia di Eredan | ENT_LIBERE | ON_TAG | `scar:emptied@REG_VALLE_VERDE` | 475 |
| 10 | 8 | La Repubblica della Valle | ENT_ALDRIC | LINE_EXHAUSTED | — | 353 |
| 10 | 7 | La Lega delle Sette | ENT_LIBERE | ON_TAG | `charter_written` | 373 |
| 8 | 8 | Il Banco Nero | ENT_SALE | ON_TAG | `debt_called` | 618 |
| 5 | 7 | Le Strade della Cenere | ENT_CENERE | ON_TAG | `condition:cut_off` | 552 |
| 4 | 8 | Il Regno di Nahr | ENT_NAHR | ON_TAG | `nahr_settled` | 457 |
| 6 | 5 | L'Archivio Aperto | ENT_LYRA | ON_TAG | `ledger_public` | 340 |
| 5 | 4 | L'Accademia delle Misure | ENT_LYRA | ON_TAG | `succession_by_law` | 457 |
| 5 | 4 | Vaerax Ridestato | ENT_VAERAX | ON_TAG | `crystal_exploited` | 301 |
| 3 | 4 | La Reggenza del Granaio | ENT_ALDRIC | ON_TAG | `grain_requisitioned` | 380 |
| 2 | 4 | Il Culto della Misura | ENT_LYRA | LINE_EXHAUSTED | — | 261 |
| 4 | 1 | I Forni Riaccesi | ENT_CENERE | ON_TAG | `scar:open_wound` | 475 |
| 3 | 2 | La Scuola del Vetro | ENT_VETRO | ON_TAG | `escort_sworn` | 320 |
| 2 | 2 | La Mano Rimessa | ENT_SALE | ON_TAG | `debt_forgiven` | 772 |
| 1 | 2 | La Corona Restaurata | ENT_ALDRIC | ON_TAG | `heir_named` | 462 |
| **0** | 3 | La Diaspora di Nahr | ENT_NAHR | ON_TAG | `twice_uprooted` | 192 |
| 1 | 2 | La Leggenda della Montagna | ENT_VAERAX | ON_TAG | `mountain_forgotten` | 210 |
| **0** | 1 | La Compagnia del Sale | ENT_SALE | LINE_EXHAUSTED | — | 195 |
| **0** | 1 | L'Inquisizione del Vetro | ENT_VETRO | ON_TAG | `relic_shown` | 290 |
