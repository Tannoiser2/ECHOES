...
| 10 | 13 | L'Egemonia di Eredan | ENT_LIBERE | ON_TAG | `scar:emptied@REG_VALLE_VERDE` | 571 |
| 11 | 11 | Il Culto della Misura | ENT_LYRA | LINE_EXHAUSTED | — | 454 |
| 10 | 8 | La Diaspora di Nahr | ENT_NAHR | ON_TAG | `twice_uprooted` | 482 |
| 7 | 10 | Il Banco Nero | ENT_SALE | ON_TAG | `debt_called` | 454 |
| 9 | 7 | La Lega delle Sette | ENT_LIBERE | ON_TAG | `charter_written` | 393 |
| 8 | 7 | Il Regno di Nahr | ENT_NAHR | ON_TAG | `nahr_settled` | 401 |
| 6 | 8 | Vaerax Ridestato | ENT_VAERAX | ON_TAG | `crystal_exploited` | 424 |
| 5 | 6 | I Forni Riaccesi | ENT_CENERE | ON_TAG | `scar:open_wound` | 382 |
| 4 | 4 | La Corona Restaurata | ENT_ALDRIC | ON_TAG | `heir_named` | 545 |
| 4 | 1 | La Compagnia del Sale | ENT_SALE | LINE_EXHAUSTED | — | 639 |
| 1 | 1 | La Leggenda della Montagna | ENT_VAERAX | ON_TAG | `mountain_forgotten` | 1040 |
| **0** | 1 | La Reggenza del Granaio | ENT_ALDRIC | ON_TAG | `grain_requisitioned` | 596 |
| 1 | **0** | L'Accademia delle Misure | ENT_LYRA | ON_TAG | `succession_by_law` | 670 |
