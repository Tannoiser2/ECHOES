...
| 13 | 12 | La Repubblica della Valle | ENT_ALDRIC | LINE_EXHAUSTED | — | 494 |
| 12 | 9 | L'Egemonia di Eredan | ENT_LIBERE | ON_TAG | `scar:emptied@REG_VALLE_VERDE` | 576 |
| 10 | 9 | Vaerax Ridestato | ENT_VAERAX | ON_TAG | `crystal_exploited` | 404 |
| 7 | 6 | La Diaspora di Nahr | ENT_NAHR | ON_TAG | `twice_uprooted` | 378 |
| 6 | 5 | La Lega delle Sette | ENT_LIBERE | ON_TAG | `charter_written` | 495 |
| 5 | 5 | La Compagnia del Sale | ENT_SALE | LINE_EXHAUSTED | — | 265 |
| 3 | 3 | La Corona Restaurata | ENT_ALDRIC | ON_TAG | `heir_named` | 786 |
