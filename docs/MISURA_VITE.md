...
|---|---|---|---|---|---|---|
| 16 | 15 | Il Regno di Nahr | ENT_NAHR | ON_TAG | `nahr_settled` | 494 |
| 13 | 12 | Vaerax Ridestato | ENT_VAERAX | ON_TAG | `crystal_exploited` | 426 |
| 11 | 11 | Il Culto della Misura | ENT_LYRA | LINE_EXHAUSTED | — | 368 |
| 8 | 11 | Le Custodi della Cenere | ENT_CENERE | LINE_EXHAUSTED | — | 345 |
| 9 | 9 | I Frati del Vetro | ENT_VETRO | LINE_EXHAUSTED | — | 322 |
| 9 | 8 | La Repubblica della Valle | ENT_ALDRIC | LINE_EXHAUSTED | — | 506 |
| 3 | 8 | L'Egemonia di Eredan | ENT_LIBERE | ON_TAG | `scar:emptied@REG_VALLE_VERDE` | 288 |
| 6 | 5 | La Compagnia del Sale | ENT_SALE | LINE_EXHAUSTED | — | 369 |
| 5 | 2 | La Lega delle Sette | ENT_LIBERE | ON_TAG | `charter_written` | 443 |
| 3 | 4 | La Diaspora di Nahr | ENT_NAHR | ON_TAG | `twice_uprooted` | 368 |
| 3 | 3 | La Corona Restaurata | ENT_ALDRIC | ON_TAG | `heir_named` | 381 |
...
| ENT_LIBERE | 18 | 1 ogni 9.3 |
| ENT_LYRA | 22 | 1 ogni 7.6 |
| ENT_NAHR | 38 | 1 ogni 4.4 |
| ENT_SALE | 11 | 1 ogni 15.3 |
