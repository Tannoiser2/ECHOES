...
| 13 | 14 | L'Egemonia di Eredan | ENT_LIBERE | ON_TAG | `scar:emptied@REG_VALLE_VERDE` | 571 |
| 12 | 10 | La Repubblica della Valle | ENT_ALDRIC | LINE_EXHAUSTED | — | 491 |
| 12 | 10 | Le Custodi della Cenere | ENT_CENERE | LINE_EXHAUSTED | — | 406 |
| 11 | 11 | Gli Ospiti di Nahr | ENT_NAHR | ON_TAG | `burden_shared` | 258 |
| 9 | 10 | Il Banco Nero | ENT_SALE | ON_TAG | `debt_called` | 454 |
| 8 | 8 | L'Archivio Aperto | ENT_LYRA | ON_TAG | `ledger_public` | 535 |
| 7 | 8 | Il Culto della Misura | ENT_LYRA | LINE_EXHAUSTED | — | 458 |
| 7 | 7 | La Diaspora di Nahr | ENT_NAHR | ON_TAG | `twice_uprooted` | 482 |
| 4 | 8 | Il Regno di Nahr | ENT_NAHR | ON_TAG | `nahr_settled` | 732 |
| 4 | 8 | Vaerax Ridestato | ENT_VAERAX | ON_TAG | `crystal_exploited` | 423 |
| 4 | 6 | I Forni Riaccesi | ENT_CENERE | ON_TAG | `scar:open_wound` | 491 |
| 5 | 5 | La Lega delle Sette | ENT_LIBERE | ON_TAG | `charter_written` | 401 |
| 5 | 4 | Le Strade della Cenere | ENT_CENERE | ON_TAG | `condition:cut_off` | 707 |
| 5 | 4 | L'Accademia delle Misure | ENT_LYRA | ON_TAG | `succession_by_law` | 402 |
| 4 | 4 | La Corona Restaurata | ENT_ALDRIC | ON_TAG | `heir_named` | 545 |
| 3 | 4 | La Scuola del Vetro | ENT_VETRO | ON_TAG | `escort_sworn` | 402 |
| 2 | 3 | La Mano Rimessa | ENT_SALE | ON_TAG | `debt_forgiven` | 374 |
| 2 | 1 | L'Assemblea Permanente | ENT_LIBERE | ON_TAG | `charter_temporary` | 111 |
| **0** | 2 | La Reggenza del Granaio | ENT_ALDRIC | ON_TAG | `grain_requisitioned` | 324 |
| 1 | 1 | La Leggenda della Montagna | ENT_VAERAX | ON_TAG | `mountain_forgotten` | 670 |
...
| ENT_LYRA | 40 | 1 ogni 4.2 |
| ENT_NAHR | 48 | 1 ogni 3.5 |
| ENT_SALE | 25 | 1 ogni 6.7 |
