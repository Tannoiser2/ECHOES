...
|---|---|---|---|---|---|---|
| 15 | 12 | Il Regno di Nahr | ENT_NAHR | ON_TAG | `nahr_settled` | 440 |
| 12 | 12 | Il Culto della Misura | ENT_LYRA | LINE_EXHAUSTED | — | 368 |
| 13 | 11 | Vaerax Ridestato | ENT_VAERAX | ON_TAG | `crystal_exploited` | 381 |
| 9 | 11 | La Repubblica della Valle | ENT_ALDRIC | LINE_EXHAUSTED | — | 560 |
| 10 | 10 | Le Custodi della Cenere | ENT_CENERE | LINE_EXHAUSTED | — | 379 |
| 9 | 9 | I Frati del Vetro | ENT_VETRO | LINE_EXHAUSTED | — | 322 |
| 5 | 8 | L'Egemonia di Eredan | ENT_LIBERE | ON_TAG | `scar:emptied@REG_VALLE_VERDE` | 357 |
| 7 | 6 | La Compagnia del Sale | ENT_SALE | LINE_EXHAUSTED | — | 369 |
| 3 | 8 | La Diaspora di Nahr | ENT_NAHR | ON_TAG | `twice_uprooted` | 556 |
| 5 | 4 | La Lega delle Sette | ENT_LIBERE | ON_TAG | `charter_written` | 443 |
