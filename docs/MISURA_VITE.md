...
|---|---|---|---|---|---|---|
| 15 | 15 | Le Custodi della Cenere | ENT_CENERE | LINE_EXHAUSTED | — | 476 |
| 14 | 13 | La Repubblica della Valle | ENT_ALDRIC | LINE_EXHAUSTED | — | 495 |
| 13 | 13 | I Frati del Vetro | ENT_VETRO | LINE_EXHAUSTED | — | 235 |
| 14 | 11 | Il Culto della Misura | ENT_LYRA | LINE_EXHAUSTED | — | 494 |
| 11 | 13 | Vaerax Ridestato | ENT_VAERAX | ON_TAG | `crystal_exploited` | 323 |
| 7 | 6 | L'Egemonia di Eredan | ENT_LIBERE | ON_TAG | `scar:emptied@REG_VALLE_VERDE` | 576 |
| 6 | 6 | La Diaspora di Nahr | ENT_NAHR | ON_TAG | `twice_uprooted` | 378 |
| 5 | 6 | La Lega delle Sette | ENT_LIBERE | ON_TAG | `charter_written` | 404 |
| 5 | 6 | La Compagnia del Sale | ENT_SALE | LINE_EXHAUSTED | — | 265 |
| 4 | 5 | La Corona Restaurata | ENT_ALDRIC | ON_TAG | `heir_named` | 521 |
| 4 | 2 | Il Regno di Nahr | ENT_NAHR | ON_TAG | `nahr_settled` | 619 |
...
| ENT_CENERE | 30 | 1 ogni 5.6 |
| ENT_LIBERE | 24 | 1 ogni 7.0 |
| ENT_LYRA | 25 | 1 ogni 6.7 |
| ENT_NAHR | 18 | 1 ogni 9.3 |
