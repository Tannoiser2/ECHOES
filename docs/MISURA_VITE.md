...
| 10 | 11 | Il Culto della Misura | ENT_LYRA | LINE_EXHAUSTED | — | 411 |
| 11 | 9 | La Repubblica della Valle | ENT_ALDRIC | LINE_EXHAUSTED | — | 393 |
| 10 | 10 | Le Custodi della Cenere | ENT_CENERE | LINE_EXHAUSTED | — | 406 |
| 10 | 9 | La Diaspora di Nahr | ENT_NAHR | ON_TAG | `twice_uprooted` | 406 |
| 12 | 7 | Vaerax Ridestato | ENT_VAERAX | ON_TAG | `crystal_exploited` | 444 |
| 9 | 9 | Il Banco Nero | ENT_SALE | ON_TAG | `debt_called` | 454 |
| 8 | 9 | I Forni Riaccesi | ENT_CENERE | ON_TAG | `scar:open_wound` | 458 |
| 6 | 11 | La Lega delle Sette | ENT_LIBERE | ON_TAG | `charter_written` | 402 |
| 9 | 7 | L'Egemonia di Eredan | ENT_LIBERE | ON_TAG | `scar:emptied@REG_VALLE_VERDE` | 644 |
| 7 | 8 | Il Regno di Nahr | ENT_NAHR | ON_TAG | `nahr_settled` | 684 |
| 4 | 4 | La Corona Restaurata | ENT_ALDRIC | ON_TAG | `heir_named` | 571 |
| 2 | 2 | L'Accademia delle Misure | ENT_LYRA | ON_TAG | `succession_by_law` | 792 |
| 2 | 2 | La Compagnia del Sale | ENT_SALE | LINE_EXHAUSTED | — | 1177 |
| **0** | 2 | La Leggenda della Montagna | ENT_VAERAX | ON_TAG | `mountain_forgotten` | 816 |
| 2 | **0** | L'Inquisizione del Vetro | ENT_VETRO | ON_TAG | `relic_shown` | 999 |
| **0** | 1 | La Reggenza del Granaio | ENT_ALDRIC | ON_TAG | `grain_requisitioned` | 596 |
