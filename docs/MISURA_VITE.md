...
|---|---|---|---|---|---|---|
| 16 | 11 | Il Regno di Nahr | ENT_NAHR | ON_TAG | `nahr_settled` | 440 |
| 14 | 8 | Vaerax Ridestato | ENT_VAERAX | ON_TAG | `crystal_exploited` | 381 |
...
| 6 | 9 | Il Culto della Misura | ENT_LYRA | LINE_EXHAUSTED | — | 369 |
| 3 | 6 | La Repubblica della Valle | ENT_ALDRIC | LINE_EXHAUSTED | — | 683 |
| 6 | 2 | La Lega delle Sette | ENT_LIBERE | ON_TAG | `charter_written` | 525 |
| 1 | 1 | La Corona Restaurata | ENT_ALDRIC | ON_TAG | `heir_named` | 791 |
...
|---|---|---|
| ENT_ALDRIC | 11 | 1 ogni 15.3 |
| ENT_CENERE | 20 | 1 ogni 8.4 |
| ENT_LIBERE | 23 | 1 ogni 7.3 |
| ENT_LYRA | 15 | 1 ogni 11.2 |
| ENT_NAHR | 27 | 1 ogni 6.2 |
