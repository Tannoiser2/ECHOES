...
|---|---|---|---|---|---|---|
| 12 | 16 | Il Regno di Nahr | ENT_NAHR | ON_TAG | `nahr_settled` | 518 |
| 12 | 12 | Il Culto della Misura | ENT_LYRA | LINE_EXHAUSTED | — | 368 |
| 10 | 11 | Le Custodi della Cenere | ENT_CENERE | LINE_EXHAUSTED | — | 345 |
| 10 | 11 | Vaerax Ridestato | ENT_VAERAX | ON_TAG | `crystal_exploited` | 426 |
| 9 | 9 | I Frati del Vetro | ENT_VETRO | LINE_EXHAUSTED | — | 322 |
| 8 | 9 | La Repubblica della Valle | ENT_ALDRIC | LINE_EXHAUSTED | — | 641 |
| 7 | 8 | La Lega delle Sette | ENT_LIBERE | ON_TAG | `charter_written` | 443 |
| 7 | 7 | La Compagnia del Sale | ENT_SALE | LINE_EXHAUSTED | — | 369 |
| 6 | 4 | L'Egemonia di Eredan | ENT_LIBERE | ON_TAG | `scar:emptied@REG_VALLE_VERDE` | 368 |
| 5 | 5 | La Diaspora di Nahr | ENT_NAHR | ON_TAG | `twice_uprooted` | 369 |
| 2 | 2 | La Corona Restaurata | ENT_ALDRIC | ON_TAG | `heir_named` | 381 |
| 1 | **0** | Il Banco Nero | ENT_SALE | ON_TAG | `debt_called` | 509 |
