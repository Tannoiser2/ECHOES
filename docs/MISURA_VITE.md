...
| 7 | 10 | L'Egemonia di Eredan | ENT_LIBERE | ON_TAG | `scar:emptied@REG_VALLE_VERDE` | 604 |
| 7 | 6 | La Compagnia del Sale | ENT_SALE | LINE_EXHAUSTED | — | 265 |
| 6 | 6 | La Lega delle Sette | ENT_LIBERE | ON_TAG | `charter_written` | 404 |
| 6 | 6 | La Diaspora di Nahr | ENT_NAHR | ON_TAG | `twice_uprooted` | 378 |
| 3 | 5 | La Corona Restaurata | ENT_ALDRIC | ON_TAG | `heir_named` | 521 |
