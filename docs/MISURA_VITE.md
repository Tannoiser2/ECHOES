...
|---|---|---|---|---|---|---|
| 15 | 15 | Gli Ospiti di Nahr | ENT_NAHR | ON_TAG | `burden_shared` | 363 |
| 14 | 14 | I Frati del Vetro | ENT_VETRO | LINE_EXHAUSTED | — | 458 |
| 15 | 10 | L'Egemonia di Eredan | ENT_LIBERE | ON_TAG | `scar:emptied@REG_VALLE_VERDE` | 565 |
| 12 | 12 | Le Custodi della Cenere | ENT_CENERE | LINE_EXHAUSTED | — | 406 |
| 11 | 12 | La Repubblica della Valle | ENT_ALDRIC | LINE_EXHAUSTED | — | 393 |
| 9 | 11 | Il Banco Nero | ENT_SALE | ON_TAG | `debt_called` | 454 |
| 8 | 8 | L'Archivio Aperto | ENT_LYRA | ON_TAG | `ledger_public` | 535 |
| 7 | 7 | La Diaspora di Nahr | ENT_NAHR | ON_TAG | `twice_uprooted` | 406 |
| 6 | 6 | Il Culto della Misura | ENT_LYRA | LINE_EXHAUSTED | — | 454 |
| 6 | 6 | L'Accademia delle Misure | ENT_LYRA | ON_TAG | `succession_by_law` | 458 |
| 5 | 6 | Le Strade della Cenere | ENT_CENERE | ON_TAG | `condition:cut_off` | 666 |
| 6 | 5 | Vaerax Ridestato | ENT_VAERAX | ON_TAG | `crystal_exploited` | 259 |
| 4 | 4 | La Corona Restaurata | ENT_ALDRIC | ON_TAG | `heir_named` | 545 |
| 4 | 4 | I Forni Riaccesi | ENT_CENERE | ON_TAG | `scar:open_wound` | 535 |
| 4 | 4 | La Lega delle Sette | ENT_LIBERE | ON_TAG | `charter_written` | 411 |
| 3 | 3 | La Scuola del Vetro | ENT_VETRO | ON_TAG | `escort_sworn` | 402 |
| 4 | 1 | L'Assemblea Permanente | ENT_LIBERE | ON_TAG | `charter_temporary` | 307 |
| 2 | 3 | Il Regno di Nahr | ENT_NAHR | ON_TAG | `nahr_settled` | 707 |
| 3 | 2 | La Mano Rimessa | ENT_SALE | ON_TAG | `debt_forgiven` | 845 |
| 2 | 1 | L'Inquisizione del Vetro | ENT_VETRO | ON_TAG | `relic_shown` | 647 |
