...
| 12 | 14 | La Repubblica della Valle | ENT_ALDRIC | LINE_EXHAUSTED | — | 494 |
| 14 | 12 | Il Culto della Misura | ENT_LYRA | LINE_EXHAUSTED | — | 494 |
| 13 | 13 | I Frati del Vetro | ENT_VETRO | LINE_EXHAUSTED | — | 235 |
| 13 | 10 | Vaerax Ridestato | ENT_VAERAX | ON_TAG | `crystal_exploited` | 323 |
| 10 | 7 | L'Egemonia di Eredan | ENT_LIBERE | ON_TAG | `scar:emptied@REG_VALLE_VERDE` | 604 |
| 7 | 6 | La Compagnia del Sale | ENT_SALE | LINE_EXHAUSTED | — | 590 |
| 7 | 5 | La Lega delle Sette | ENT_LIBERE | ON_TAG | `charter_written` | 495 |
| 6 | 6 | La Diaspora di Nahr | ENT_NAHR | ON_TAG | `twice_uprooted` | 378 |
| 3 | 6 | La Corona Restaurata | ENT_ALDRIC | ON_TAG | `heir_named` | 576 |
| 3 | 1 | Il Regno di Nahr | ENT_NAHR | ON_TAG | `nahr_settled` | 708 |
