...
|---|---|---|---|---|---|---|
| 15 | 14 | Gli Ospiti di Nahr | ENT_NAHR | ON_TAG | `burden_shared` | 401 |
| 14 | 13 | I Frati del Vetro | ENT_VETRO | LINE_EXHAUSTED | — | 458 |
| 14 | 12 | L'Egemonia di Eredan | ENT_LIBERE | ON_TAG | `scar:emptied@REG_VALLE_VERDE` | 571 |
| 13 | 12 | Le Custodi della Cenere | ENT_CENERE | LINE_EXHAUSTED | — | 401 |
| 12 | 10 | La Repubblica della Valle | ENT_ALDRIC | LINE_EXHAUSTED | — | 465 |
| 10 | 11 | Il Banco Nero | ENT_SALE | ON_TAG | `debt_called` | 454 |
| 8 | 10 | Vaerax Ridestato | ENT_VAERAX | ON_TAG | `crystal_exploited` | 352 |
| 8 | 7 | L'Archivio Aperto | ENT_LYRA | ON_TAG | `ledger_public` | 535 |
| 5 | 9 | La Diaspora di Nahr | ENT_NAHR | ON_TAG | `twice_uprooted` | 406 |
| 6 | 6 | Il Culto della Misura | ENT_LYRA | LINE_EXHAUSTED | — | 454 |
| 6 | 5 | L'Accademia delle Misure | ENT_LYRA | ON_TAG | `succession_by_law` | 458 |
| 5 | 5 | Le Strade della Cenere | ENT_CENERE | ON_TAG | `condition:cut_off` | 666 |
| 4 | 5 | I Forni Riaccesi | ENT_CENERE | ON_TAG | `scar:open_wound` | 382 |
| 4 | 4 | La Corona Restaurata | ENT_ALDRIC | ON_TAG | `heir_named` | 545 |
| 3 | 5 | La Scuola del Vetro | ENT_VETRO | ON_TAG | `escort_sworn` | 424 |
| 4 | 3 | Il Regno di Nahr | ENT_NAHR | ON_TAG | `nahr_settled` | 666 |
| 4 | 2 | La Lega delle Sette | ENT_LIBERE | ON_TAG | `charter_written` | 411 |
| 3 | 2 | La Mano Rimessa | ENT_SALE | ON_TAG | `debt_forgiven` | 845 |
| 2 | 2 | L'Assemblea Permanente | ENT_LIBERE | ON_TAG | `charter_temporary` | 307 |
