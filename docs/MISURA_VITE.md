...
| 13 | 13 | Le Custodi della Cenere | ENT_CENERE | LINE_EXHAUSTED | — | 401 |
| 10 | 11 | La Repubblica della Valle | ENT_ALDRIC | LINE_EXHAUSTED | — | 465 |
| 11 | 10 | Il Banco Nero | ENT_SALE | ON_TAG | `debt_called` | 454 |
| 12 | 8 | Gli Ospiti di Nahr | ENT_NAHR | ON_TAG | `burden_shared` | 363 |
| 7 | 12 | Il Regno di Nahr | ENT_NAHR | ON_TAG | `nahr_settled` | 647 |
| 7 | 9 | L'Egemonia di Eredan | ENT_LIBERE | ON_TAG | `scar:emptied@REG_VALLE_VERDE` | 402 |
| 6 | 10 | La Lega delle Sette | ENT_LIBERE | ON_TAG | `charter_written` | 491 |
| 7 | 9 | Vaerax Ridestato | ENT_VAERAX | ON_TAG | `crystal_exploited` | 309 |
| 7 | 7 | L'Archivio Aperto | ENT_LYRA | ON_TAG | `ledger_public` | 566 |
| 5 | 8 | Il Culto della Misura | ENT_LYRA | LINE_EXHAUSTED | — | 454 |
...
| 5 | 4 | La Diaspora di Nahr | ENT_NAHR | ON_TAG | `twice_uprooted` | 223 |
...
| 3 | 3 | La Mano Rimessa | ENT_SALE | ON_TAG | `debt_forgiven` | 374 |
| 2 | 3 | La Leggenda della Montagna | ENT_VAERAX | ON_TAG | `mountain_forgotten` | 496 |
| 3 | 2 | La Scuola del Vetro | ENT_VETRO | ON_TAG | `escort_sworn` | 402 |
| 1 | 1 | La Reggenza del Granaio | ENT_ALDRIC | ON_TAG | `grain_requisitioned` | 324 |
