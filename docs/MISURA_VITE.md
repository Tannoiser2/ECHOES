...
| 10 | 7 | Vaerax Ridestato | ENT_VAERAX | ON_TAG | `crystal_exploited` | 565 |
...
| 5 | 4 | Il Regno di Nahr | ENT_NAHR | ON_TAG | `nahr_settled` | 707 |
...
| **0** | 2 | La Leggenda della Montagna | ENT_VAERAX | ON_TAG | `mountain_forgotten` | 763 |
