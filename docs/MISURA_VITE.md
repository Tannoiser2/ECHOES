...
| 7 | 7 | La Lega delle Sette | ENT_LIBERE | ON_TAG | `charter_written` | 402 |
| 8 | 5 | Vaerax Ridestato | ENT_VAERAX | ON_TAG | `crystal_exploited` | 352 |
| 5 | 5 | L'Accademia delle Misure | ENT_LYRA | ON_TAG | `succession_by_law` | 596 |
...
| 2 | 1 | La Compagnia del Sale | ENT_SALE | LINE_EXHAUSTED | — | 406 |
| **0** | 1 | L'Inquisizione del Vetro | ENT_VETRO | ON_TAG | `relic_shown` | 326 |
