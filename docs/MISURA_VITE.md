...
|---|---|---|---|---|---|---|
| 14 | 15 | Il Regno di Nahr | ENT_NAHR | ON_TAG | `nahr_settled` | 537 |
| 14 | 15 | I Frati del Vetro | ENT_VETRO | LINE_EXHAUSTED | — | 435 |
| 12 | 13 | La Repubblica della Valle | ENT_ALDRIC | LINE_EXHAUSTED | — | 528 |
| 10 | 10 | Le Custodi della Cenere | ENT_CENERE | LINE_EXHAUSTED | — | 426 |
| 10 | 8 | Vaerax Ridestato | ENT_VAERAX | ON_TAG | `crystal_exploited` | 308 |
| 9 | 8 | La Lega delle Sette | ENT_LIBERE | ON_TAG | `charter_written` | 367 |
| 8 | 8 | Il Culto della Misura | ENT_LYRA | LINE_EXHAUSTED | — | 545 |
| 7 | 7 | Il Banco Nero | ENT_SALE | ON_TAG | `debt_called` | 420 |
| 6 | 7 | Gli Ospiti di Nahr | ENT_NAHR | ON_TAG | `burden_shared` | 140 |
| 4 | 8 | L'Egemonia di Eredan | ENT_LIBERE | ON_TAG | `scar:emptied@REG_VALLE_VERDE` | 528 |
| 6 | 5 | L'Assemblea Permanente | ENT_LIBERE | ON_TAG | `charter_temporary` | 331 |
| 5 | 5 | La Corona Restaurata | ENT_ALDRIC | ON_TAG | `heir_named` | 618 |
| 5 | 5 | L'Accademia delle Misure | ENT_LYRA | ON_TAG | `succession_by_law` | 482 |
| 5 | 5 | L'Archivio Aperto | ENT_LYRA | ON_TAG | `ledger_public` | 639 |
| 3 | 6 | I Forni Riaccesi | ENT_CENERE | ON_TAG | `scar:open_wound` | 426 |
| 5 | 3 | La Leggenda della Montagna | ENT_VAERAX | ON_TAG | `mountain_forgotten` | 545 |
| 4 | 3 | La Reggenza del Granaio | ENT_ALDRIC | ON_TAG | `grain_requisitioned` | 395 |
| 4 | 3 | Le Strade della Cenere | ENT_CENERE | ON_TAG | `condition:cut_off` | 639 |
| 3 | 2 | La Diaspora di Nahr | ENT_NAHR | ON_TAG | `twice_uprooted` | 283 |
| 2 | 3 | La Mano Rimessa | ENT_SALE | ON_TAG | `debt_forgiven` | 714 |
| 3 | 2 | La Scuola del Vetro | ENT_VETRO | ON_TAG | `escort_sworn` | 460 |
| 3 | 1 | L'Inquisizione del Vetro | ENT_VETRO | ON_TAG | `relic_shown` | 774 |
