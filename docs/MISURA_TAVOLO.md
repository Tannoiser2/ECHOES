...
| `settlement:market` | 0 | 11 | 0 | 11 |  |
| `settlement:town` | 0 | 8 | 0 | 8 |  |
| `settlement:village` | 33 | 90 | 6 | 41 |  |
| `structure:archive` | 22 | 119 | 9 | 37 |  |
| `structure:canal` | 0 | 44 | 28 | 15 |  |
| `structure:castle` | 0 | 59 | 0 | 51 |  |
| `structure:granary` | 0 | 308 | 39 | 81 |  |
| `structure:library` | 0 | 13 | 0 | 11 |  |
| `structure:palace` | 0 | 0 | 0 | 0 | **non arriva mai** |
| `structure:sealed` | 0 | 14 | 17 | 13 |  |
| `structure:tollgate` | 0 | 232 | 9 | 64 |  |
| `structure:watchtower` | 100 | 320 | 67 | 83 |  |
...
| `condition:contested` | 0 | 456 | 69 | 97 |  |
| `condition:cut_off` | 0 | 150 | 161 | 73 |  |
| `condition:emptied` | 0 | 35 | 0 | 33 |  |
| `condition:exploited` | 0 | 2 | 0 | 2 |  |
| `condition:guarded` | 0 | 32 | 0 | 26 |  |
| `condition:indebted` | 0 | 126 | 5 | 67 |  |
| `condition:lean` | 0 | 136 | 130 | 58 |  |
| `condition:mourning` | 0 | 14 | 16 | 13 |  |
| `condition:plundered` | 0 | 65 | 9 | 48 |  |
| `condition:rationed` | 0 | 96 | 69 | 50 |  |
| `condition:starving` | 0 | 87 | 141 | 51 |  |
| `condition:unrest` | 0 | 318 | 44 | 92 |  |
...
| segno | all'apertura | posato | tolto | a fine partita | |
|---|---|---|---|---|---|
| `scar:abandoned` | 0 | 54 | 0 | 45 |  |
| `scar:broken_bridge` | 0 | 2 | 20 | 2 | **tolta piu' volte di quante si posa** |
...
| `scar:emptied` | 0 | 19 | 0 | 19 |  |
| `scar:open_wound` | 0 | 9 | 0 | 9 |  |
| `scar:plundered` | 0 | 10 | 0 | 10 |  |
| `scar:sealed_border` | 0 | 0 | 0 | 0 | **non arriva mai** |
| `scar:the_empty_chair` | 0 | 5 | 0 | 5 |  |
| `scar:unanswered` | 0 | 12 | 19 | 10 | **tolta piu' volte di quante si posa** |
...
| `ash_watch` | 0 | 3 | 0 | 3 |  |
| `crowned` | 55 | 0 | 2 | 53 |  |
| `discovery:crystal` | 0 | 21 | 0 | 20 |  |
| `discovery:legend` | 0 | 166 | 0 | 81 |  |
| `discovery:relic` | 0 | 17 | 0 | 13 |  |
| `discovery:shared_record` | 0 | 0 | 0 | 0 | **non arriva mai** |
| `discovery:supervised_record` | 0 | 4 | 0 | 4 |  |
| `discovery:the_charter` | 0 | 14 | 0 | 14 |  |
| `discovery:the_ledger` | 0 | 304 | 0 | 96 |  |
| `discovery:the_measure` | 0 | 0 | 0 | 0 | **non arriva mai** |
| `discovery:the_omen` | 0 | 398 | 0 | 97 |  |
| `discovery:trade_ledger` | 0 | 237 | 0 | 87 |  |
| `discovery:written_law` | 0 | 170 | 0 | 70 |  |
| `escort_sworn` | 0 | 180 | 0 | 89 |  |
...
| `faith_established` | 0 | 9 | 0 | 8 |  |
| `grain_requisitioned` | 0 | 14 | 0 | 12 |  |
| `heir_named` | 0 | 90 | 0 | 49 |  |
| `knowledge_shared` | 0 | 170 | 0 | 70 |  |
