...
| `settlement:village` | 33 | 79 | 6 | 31 |  |
| `structure:archive` | 22 | 177 | 10 | 48 |  |
| `structure:canal` | 0 | 24 | 3 | 8 |  |
| `structure:castle` | 0 | 57 | 0 | 46 |  |
| `structure:granary` | 0 | 275 | 7 | 79 |  |
| `structure:library` | 0 | 21 | 0 | 20 |  |
| `structure:palace` | 0 | 0 | 0 | 0 | **non arriva mai** |
| `structure:sealed` | 0 | 4 | 5 | 3 |  |
| `structure:tollgate` | 0 | 356 | 9 | 94 |  |
| `structure:watchtower` | 100 | 342 | 116 | 79 |  |
...
| segno | all'apertura | posato | tolto | a fine partita | |
|---|---|---|---|---|---|
| `condition:abandoned` | 0 | 14 | 5 | 7 |  |
| `condition:contested` | 0 | 497 | 216 | 93 |  |
| `condition:cut_off` | 0 | 123 | 283 | 36 |  |
| `condition:emptied` | 0 | 19 | 1 | 17 |  |
| `condition:exploited` | 0 | 5 | 2 | 3 |  |
| `condition:guarded` | 0 | 99 | 25 | 59 |  |
| `condition:indebted` | 0 | 183 | 40 | 80 |  |
| `condition:lean` | 0 | 55 | 124 | 25 |  |
| `condition:mourning` | 0 | 23 | 58 | 13 |  |
| `condition:plundered` | 0 | 9 | 20 | 7 |  |
| `condition:rationed` | 0 | 251 | 237 | 62 |  |
| `condition:starving` | 0 | 8 | 128 | 8 |  |
| `condition:unrest` | 0 | 342 | 251 | 84 |  |
...
| segno | all'apertura | posato | tolto | a fine partita | |
|---|---|---|---|---|---|
| `scar:abandoned` | 0 | 43 | 0 | 35 |  |
| `scar:broken_bridge` | 0 | 4 | 69 | 4 | **tolta piu' volte di quante si posa** |
| `scar:broken_word` | 0 | 1 | 0 | 1 |  |
| `scar:burned_records` | 0 | 10 | 0 | 10 |  |
| `scar:changed_hands` | 0 | 51 | 0 | 41 |  |
| `scar:divided_seal` | 0 | 1 | 0 | 1 |  |
| `scar:dragonfall` | 0 | 0 | 0 | 0 | **non arriva mai** |
| `scar:emptied` | 0 | 14 | 0 | 14 |  |
| `scar:open_wound` | 0 | 4 | 0 | 4 |  |
| `scar:plundered` | 0 | 17 | 0 | 17 |  |
| `scar:sealed_border` | 0 | 12 | 0 | 10 |  |
| `scar:the_empty_chair` | 0 | 47 | 0 | 37 |  |
| `scar:unanswered` | 0 | 74 | 108 | 46 | **tolta piu' volte di quante si posa** |
...
| `faith_established` | 0 | 38 | 0 | 31 |  |
| `grain_requisitioned` | 0 | 19 | 0 | 17 |  |
| `heir_named` | 0 | 107 | 0 | 68 |  |
| `knowledge_shared` | 0 | 120 | 0 | 59 |  |
| `ledger_public` | 0 | 195 | 0 | 84 |  |
...
| segno | dove starebbe |
|---|---|
| `ash_watch` | sulla scheda della casa |
